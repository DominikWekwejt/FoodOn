...
public class ChefRegistration extends AppCompatActivity {
    String[] Pomorskie = {"Gdynia","Gdańsk","Sopot"};
    String[] Mazowieckie = {"Warszawa","Brok","Legionowo"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(statee.equals("Pomorskie")){
                    ArrayList<String> list = new ArrayList<>();
                    for (String cities : Pomorskie){
                        list.add(cities);
                    }
                ...
                if(statee.equals("Mazowieckie")){
                    ArrayList<String> list = new ArrayList<>();
                    for (String cities : Mazowieckie){
                        list.add(cities);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegistration.this,android.R.layout.simple_spinner_item,list);
                    Cityspin.setAdapter(arrayAdapter);
